...
<p><b>Student Registration Number :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Student Class:</b> <?php echo htmlentities($row->ClassName);?> &nbsp;<?php echo htmlentities($row->ClassNameNumeric);?> &nbsp; Stream-<?php echo htmlentities($row->Section);?>
<?php }
?>
                                            </div>
...
<div class="alert alert-warning left-icon-alert" role="alert">
                                            <strong>Dear <?php echo htmlentities($row->StudentName);?>'s Parent,</strong> Your child's results are not yet available.
 <?php }
?>
                                        </div>
 <?php 
...
<?php 
echo htmlentities("Dear Parent, You entered an invalid Registration Number or Class, Please enter the correct information to proceed.");
 }
?>
                                        </div>
